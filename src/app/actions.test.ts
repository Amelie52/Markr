...
describe('app/actions', () => {
    describe('#createBookmark', () => {
        it('should return a app/BOOKMARK/CREATE action', () => {
            const action = createBookmark(
                ...
                [{ label: 'emmet', value: 'emmet' }, { label: 'lorem', value: 'lorem' }]
            );
            expect(action).toEqual({
                ...
                tags: [{ label: 'emmet', value: 'emmet' }, { label: 'lorem', value: 'lorem' }],
            });
        });
    });
    ...
    describe('#editBookmark', () => {
        it('should return a app/BOOKMARK/EDIT action', () => {
            const action = editBookmark('Y89Yfreiohi8978', [{ label: 'emmet', value: 'emmet' }, { label: 'lorem', value: 'lorem' }]);
            expect(action).toEqual({
    ...
    describe('#createTags', () => {
        it('should return a app/TAGS/CREATE action', () => {
            const action = createTags([{ label: 'emmet', value: 'emmet' }, { label: 'lorem', value: 'lorem' }]);
            expect(action).toEqual({
