...
jest.mock(
  ...
  () => ({ onSubmit }: { onSubmit: (url: string, tags: Tag[]) => void }) => (
    <div data-mock="bookmark-form">
      <button
        data-testid="bookmark-form-submit-button"
        type="button"
        onClick={() =>
          onSubmit('https://www.fake-test-url/video', [{ label: 'dolor', value: 'dolor' }])
        }
      >
        Submit
      </button>
...
describe('src/create', () => {
  ...
  it('should submit correctly', async () => {
    const spy = jest.spyOn(bookmarksService, 'create').mockResolvedValueOnce({
      id: 'hihoi8799',
